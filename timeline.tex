...
\tikzset{hlbubble/.style    = {anchor=west,   hlannotation, sloped, at end, rounded corners=2pt, draw, scale=0.6, fill=red!20, text=black!50!red }}
\tikzset{titlebubble/.style = {anchor=center, hlannotation, sloped,         rounded corners=2pt, draw, scale=0.9, fill=red!10, text=black!50!red, semithick }}
...
\begin{luacode}
		...
		if ( hlrow > 0 ) then
			...
			tex.sprint('(' ..hlx.. ',0) -- ++(0,' ..dy.. ') -- node [hlbubble, semithick] {\\footnotesize ' ..text.. '} +(A);')
			tex.sprint('\\node [titlebubble] at (10,1.5) (title) {\\LARGE ' ..text.. '};')
